...
class Product:
    ...
    def to_dict(self)->Dict:
        """Convert to dict"""
        return {"product_id":self.product_id,"name":self.name,"category":self.category.value,"price":self.price,"stock":self.stock,"description":self.description,"created_at":self.created_at.isoformat()}
...
class Customer:
    ...
    def to_dict(self)->Dict:
        """Convert to dict"""
        return {"customer_id":self.customer_id,"name":self.name,"email":self.email,"phone":self.phone,"orders":self.orders,"loyalty_points":self.loyalty_points}
    ...
    def get_discount_rate(self)->float:
        ...
        if self.loyalty_points>=1000:return 0.15
        elif self.loyalty_points>=500:return 0.10
        elif self.loyalty_points>=100:return 0.05
        return 0.0
...
class Order:
    ...
    def to_dict(self)->Dict:
        """Convert to dict"""
        return {"order_id":self.order_id,"customer_id":self.customer_id,"items":self.items,"status":self.status,"total_amount":self.total_amount,"created_at":self.created_at.isoformat()}
