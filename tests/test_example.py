...
"""
import pytest
from app.example import Product,Customer,Order,Store,ProductCategory,validate_email,calculate_tax,format_currency
...
class TestProduct:
    ...
    def test_product_update_stock(self):
        ...
        assert product.update_stock(5)==True
        assert product.stock==10
        
        assert product.update_stock(-3)==True
...
class TestCustomer:
    ...
    def test_use_loyalty_points(self):
        ...
        assert customer.use_loyalty_points(50)==True
        assert customer.loyalty_points==50
